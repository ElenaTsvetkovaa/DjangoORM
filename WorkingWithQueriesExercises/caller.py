...
def update_to_16_GB_memory():
    ...
    Laptop.objects.filter(
        brand__in=["Dell", "Apple", "Acer"]
    ).update(memory=16)

def update_operation_systems():
    # laptops = Laptop.objects.all()
    # for l in laptops:
    #     if l.brand == LaptopBrandChoices.ASUS:
    #         l.operation_system = LaptopOperationSystemChoices.WINDOWS
    #     elif l.brand == LaptopBrandChoices.APPLE:
    #         l.operation_system = LaptopOperationSystemChoices.MACOS
    #     elif l.brand == LaptopBrandChoices.DELL or l.brand== LaptopBrandChoices.ACER:
    #         l.operation_system = LaptopOperationSystemChoices.LINUX
    #     elif l.brand == LaptopBrandChoices.LENOVO:
    #         l.operation_system = LaptopOperationSystemChoices.CHROME_OS
    #
    #
